#!/usr/bin/env python3
"""
CodexSafe - Security Platform Launcher

🔒 Next-Generation Secure Coding Platform
⚡ Turning Code Into Confidence with AI-powered security analysis
"""
...
╔══════════════════════════════════════════════════════════════╗
║                                                              ║
║    🔒 CodexSafe - Explainable Security Platform             ║
║                                                              ║
║    ⚡ SECURE • EXPLAINABLE • CONFIDENT ⚡                   ║
║                                                              ║
║    Turning code into confidence                              ║
║    Next-generation security analysis platform               ║
║                                                              ║
╚══════════════════════════════════════════════════════════════╝
"""
    print(banner)
...
📁 Available papers:""")
    ...
    print("🌐 Starting CodexSafe web interface...")
    ...
    try:
        ...
        print(f"\n❌ Failed to start CodexSafe: {e}")
        print("Please check if Streamlit is properly installed.")
        sys.exit(1)
    except KeyboardInterrupt:
        print("\n\n🛑 CodexSafe server stopped by user")
        print("Thank you for using CodexSafe! 🔒")
    except Exception as e:
        print(f"\n❌ Unexpected error: {e}")
